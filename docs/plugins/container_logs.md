...
| exclude_file_log_path | A list of file glob patterns to exclude from reading | []string | `[/var/log/containers/dbdot-collector-* /var/log/containers/dbdot-*-collector-* /var/log/containers/observiq-*-collector-* /var/log/containers/bindplane-*-agent-*]` | false |  |
...
| offset_storage_dir | The directory that the offset storage file will be created | string | `${env:DBDOT_OTEL_COLLECTOR_HOME}/storage` | false |  |
...
receivers:
  plugin:
    ...
    parameters:
      ...
      exclude_file_log_path: [/var/log/containers/dbdot-collector-* /var/log/containers/dbdot-*-collector-* /var/log/containers/observiq-*-collector-* /var/log/containers/bindplane-*-agent-*]
      body_json_parsing: true
      start_at: end
      log_driver: auto
      offset_storage_dir: ${env:DBDOT_OTEL_COLLECTOR_HOME}/storage
      parse: true
```
