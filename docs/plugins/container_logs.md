...
| exclude_file_log_path | A list of file glob patterns to exclude from reading | []string | `[/var/log/containers/dynatrace-bindplane-otel-collector-*]` | false |  |
...
receivers:
  plugin:
    ...
    parameters:
      ...
      exclude_file_log_path: [/var/log/containers/dynatrace-bindplane-otel-collector-*]
