...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_macos.sh)" install_macos.sh
```
...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_macos.sh)" install_macos.sh -e <your_endpoint> -s <secret-key>
```
...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_macos.sh)" install_macos.sh -r
```
