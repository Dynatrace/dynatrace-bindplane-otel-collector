...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_unix.sh)" install_unix.sh
```
...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_unix.sh)" install_unix.sh -e <your_endpoint> -s <secret-key>
```
...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_unix.sh)" install_unix.sh -f <path_to_package>
```

### RPM Installation
First download the RPM package for your architecture from the [releases page](https://github.com/dynatrace/dbdot-collector/releases/latest).
...
### DEB Installation
First download the DEB package for your architecture from the [releases page](https://github.com/dynatrace/dbdot-collector/releases/latest).
...
```sh
sudo sh -c "$(curl -fsSlL https://github.com/dynatrace/dbdot-collector/releases/latest/download/install_unix.sh)" install_unix.sh -r
```
