...
```bash
cosign verify-blob --key ./signature/bp_agent_key.pub --signature dynatrace-bindplane-otel-collector-v1.47.1-darwin-amd64.tar.gz.sig dynatrace-bindplane-otel-collector-v1.47.1-darwin-amd64.tar.gz
```
